...
export const Certifications = () => {
  return (
    <div className="certification-container">
      <br />
      <h2 className="skills-heading" >Certification</h2>
      <p className="skills-p" >"Meta Front-End Developer Professional Certificate"</p>
      <br />
      <Card className="skills-card">
        <CardBody className="overflow-visible p-0 ">
          <Image
            ...
            onClick={() => window.open("https://coursera.org/share/c63b46afca5191348bec73811fde8906")}
